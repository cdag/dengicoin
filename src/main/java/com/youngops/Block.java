...
public final class Block {
    ...
    /**
     * Generates a secure nonce using a cryptographically strong random number
     * generator. The nonce is an 8-byte long value that is wrapped in a
     * ByteBuffer and converted to a long. The absolute value of the generated
     * long is returned to ensure a positive nonce.
     *
    ...
    /**
     * Returns a string representation of the Block object. The string includes
     * the block index, timestamp, previous hash, current hash, nonce, and all
     * transactions.
     *
