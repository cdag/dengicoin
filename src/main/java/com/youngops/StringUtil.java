...
public class StringUtil {
    ...
    /**
     * Private constructor to prevent instantiation. Throws
    ...
    /**
     * Applies SHA-256 hashing algorithm to the input string and returns the
    ...
    /**
     * Signs the input data using the Ed25519 algorithm and the provided private
     * key.
     *
    ...
    /**
     * Verifies the signature of the input data using the Ed25519 algorithm and
